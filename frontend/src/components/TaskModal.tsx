      ...
      {isOpen && (
        <div className='bg-white p-6 border border-gray-200 rounded-lg shadow-lg w-96'>
          ...
          <form className='space-y-4' onSubmit={handleSubmit}>
            ...
            <button
              type='submit'
              className='w-full bg-black text-white py-2 px-4 rounded-md shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer'
            >
              Save Task
            </button>
          </form>
